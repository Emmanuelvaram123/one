...
<head>
    ...
    <title>NexusShop — AI E‑Commerce</title>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                ...
                <h2>Discover the latest trends in fashion, technology and accessories & curated just for you. Enjoy limited-time deals and free shipping on selected items.</h2>
                <div>
